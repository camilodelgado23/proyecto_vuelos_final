...
def fetch_airlines_data(limit=100000):
...
def process_airlines_data(airplanes):
...
# def main():
#     try:
#         airlines_data = fetch_airlines_data()
#         processed_airlines = process_airlines_data(airlines_data)
#         save_to_csv(processed_airlines)
